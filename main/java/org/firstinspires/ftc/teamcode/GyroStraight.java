...
/*Created by Akhil Maheepathi 9/16/2018*/
...
@Autonomous(name = "GyroStraight", group = "Gyro Video")
//@Disabled
public class GyroStraight extends LinearOpMode {  //Linear op mode is being used so the program does not get stuck in loop()
